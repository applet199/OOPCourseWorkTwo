...
class Ui_FiveOptionsQuestionDialog(object):
    def setupUi(self, FiveOptionsQuestionDialog):
        ...
        self.verticalLayout.addWidget(self.radioButton, 0, QtCore.Qt.AlignLeft)
        self.radioButton_2 = QtWidgets.QRadioButton(self.layoutWidget)
        self.radioButton_2.setObjectName("radioButton_2")
        self.verticalLayout.addWidget(self.radioButton_2, 0, QtCore.Qt.AlignLeft)
        self.radioButton_3 = QtWidgets.QRadioButton(self.layoutWidget)
        self.radioButton_3.setObjectName("radioButton_3")
        self.verticalLayout.addWidget(self.radioButton_3, 0, QtCore.Qt.AlignLeft)
        self.radioButton_4 = QtWidgets.QRadioButton(self.layoutWidget)
        self.radioButton_4.setObjectName("radioButton_4")
        self.verticalLayout.addWidget(self.radioButton_4, 0, QtCore.Qt.AlignLeft)
        ...
        self.verticalLayout.addWidget(self.radioButton_5, 0, QtCore.Qt.AlignLeft)
    ...
    def retranslateUi(self, FiveOptionsQuestionDialog):
        ...
        self.label_2.setText(_translate("FiveOptionsQuestionDialog", "Points: 10"))
